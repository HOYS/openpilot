...
class CAR:
  ...
  BUICK_TOURX = "BUICK REGAL TOURX ESSENCE 2018"
...
DBC = {
  ...
  CAR.BUICK_TOURX: dbc_dict('gm_global_a_powertrain', 'gm_global_a_object', chassis_dbc='gm_global_a_chassis'),
