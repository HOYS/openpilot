...
def get_powertrain_can_parser(CP, canbus):
  ...
  if CP.carFingerprint in (CAR.VOLT, CAR.MALIBU, CAR.HOLDEN_ASTRA, CAR.BUICK_TOURX):
    signals += [
...
class CarState(object):
  ...
  def update(self, pt_cp):
    ...
    if self.car_fingerprint in (CAR.VOLT, CAR.MALIBU, CAR.HOLDEN_ASTRA, CAR.BUICK_TOURX):
